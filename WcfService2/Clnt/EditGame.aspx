<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditGame.aspx.cs" Inherits="Clnt.EditGame" %>
        ...
        <h2>
            ...
            <div class="frm">
                <div class="auto-style1">
                     Tytuł:<br /><asp:TextBox  ID="tbTytul" runat="server" Height="25px" Width="200px"></asp:TextBox><br /><br />
                     Rok wydania:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="element2">
                    Producent:<br /><asp:DropDownList ID="ddlProducent" runat="server" Height="25px" Width="200px">
                     ...
                     Kraj:<br /><asp:TextBox ID="tbKraj" runat="server"  Height="25px" Width="200px"></asp:TextBox>
