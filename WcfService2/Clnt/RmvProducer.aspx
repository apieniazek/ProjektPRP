<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RmvProducer.aspx.cs" Inherits="Clnt.RmvProducer" %>
...
<div id="container">
    ...
    <div id="boxy">
        ...
        <h2>
            <asp:Label ID="lbProducent" runat="server" Height="50px" Width="100%"></asp:Label>                 
        </h2> 
            <div class="frm">
